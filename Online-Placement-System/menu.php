<!-- Main menu (tabs) -->
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                ...
                <li><a href="EmployerReg.php">New Employer<span class="tab-l"></span><span class="tab-r"></span></a></li>
                 <li><a href="JobSeekerReg.php">New Job Seeker<span class="tab-l"></span><span class="tab-r"></span></a></li>
